...
setup(
  ...
  url = 'https://github.com/PasaOpasen',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/PasaOpasen/PersianG2P/archive/0.1.tar.gz',    # I explain this later on
